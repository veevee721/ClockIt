                            ...
                            <?php 
                              foreach($employee as $row){
                                ...
                                <tr>
                                  ...
                                  <td><a href='<?php echo base_url(); ?>hr/view_profile/<?php echo $row->plantilla; ?>'><abbr title="View Employee Profile"><i class="fa fa-eye"></i></abbr></a>
                                            <a href='<?php echo base_url(); ?>hr/archive_profile/<?php echo $row->plantilla; ?>'><abbr title="Archive Employee Profile"><i class="fa fa-archive"></i></abbr></a></td>
                                </tr>
                                <?php
                              }
                            ?>
